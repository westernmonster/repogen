...
type Doctor struct {
	...
	Decfield1                                      float64       `db:"decfield1" json:"decfield1"`                                                                                       // Decfield1
	Charfield                                      string        `db:"charfield" json:"charfield"`                                                                                       // Charfield
